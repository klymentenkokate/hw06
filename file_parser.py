...
if __name__ == '__main__':
    ...
    print(f'Document doc: {DOC_DOCS}')
    print(f'Document docx: {DOCX_DOCS}')
    print(f'Document txt: {TXT_DOCS}')
    print(f'Document pdf: {PDF_DOCS}')
    print(f'Document xlsx: {XLSX_DOCS}')
    print(f'Document pptx: {PPTX_DOCS}')
